...
export class InitialMigration1694622195630 implements MigrationInterface {
    name = 'InitialMigration1694622195630'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "RealEstate" ("id" SERIAL NOT NULL, "sold" boolean NOT NULL DEFAULT false, "value" numeric(12,2) NOT NULL DEFAULT '0', "size" integer NOT NULL, "createAt" date NOT NULL DEFAULT now(), "updateAt" date NOT NULL DEFAULT now(), "addressId" integer, "categoriesId" integer, CONSTRAINT "REL_5cddc16f08ac35e548b39a3fa9" UNIQUE ("addressId"), CONSTRAINT "PK_1e80687649717ed24e73ed8ba9f" PRIMARY KEY ("id"))`);
